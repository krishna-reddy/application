...
<html lang="en">
  ...
  <form action="updateContact.do" class="form-horizontal" role="form" method="post">
     
  <div class="form-group">
    <label for="fname" class="col-sm-2 control-label">First Name</label>
    <div class="col-sm-10">
      <input  type="text" name="firstname" value="${contact.firstname }"  class="form-control" id="fname" placeholder="First Name" required autofocus>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input  type="text" name="lastname" value="${contact.lastname }"  class="form-control" id="lname" placeholder="Last Name" required>
    </div>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <input  type="text" name="telephone" value="${contact.telephone }"  class="form-control" id="mnumber" placeholder="Mobile Number">
    </div>
  </div>
